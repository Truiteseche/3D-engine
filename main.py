...
class Point:
    ...
    def projectPointOnScreen(self):
        ...
        It converts 3d coord in the world to 2d coord on the screen
        """
...
engine.create3dObject((-50, 0, 0), [(0, 0, 0), (100, 0, 0), (100, 100, 0), (0, 100, 0), (0, 0, 100), (100, 0, 100), (100, 100, 100), (0, 100, 100)], (random.randint(0, 255), random.randint(0, 255), random.randint(0, 255)))
